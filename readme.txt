...
* Thumbs and special data on feeds - Pet and Lost pet feed display thumbnail and special data.
...
1. Add some Types, Colors, Status and State.
...
= Where can I see this plugins working =
You can check a demo in http://temas.tk.

= How to display pets for adoption/lost pets? =
ADA Plugin uses post types for keeping everything in their place. You can add widgets or menu item for pets available, adopted pets, lost pets and so on.
...
= Can I add new statuses for lost pets/pets? =
